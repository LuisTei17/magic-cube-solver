...
class UnsolvedCube {
    ...
    mountCube() {
        ...
        rubrickCube[2][2][0] = new Cube({front: 'red', left: 'green', top: 'blue'});
        ...
        rubrickCube[2][2][2] = new Cube({back: 'yellow', bottom: 'white'});

        rubrickCube[0][0][0] = new Cube({front: 'red', right: 'orange', bottom: 'white'});
        rubrickCube[2][2][1] = new Cube({right: 'orange', bottom: 'white'});
        rubrickCube[2][1][2] = new Cube({back: 'yellow', right: 'orange', bottom: 'white'});

        return rubrickCube;
    }
}

module.exports = UnsolvedCube;